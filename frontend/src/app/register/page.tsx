...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-6 relative overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full bg-primary/5 blur-[120px] -z-10 rounded-full translate-y-[-50%]" />
      ...
      >
        <div className="text-center mb-8">
          <motion.div 
            ...
            className="inline-flex items-center gap-2 font-bold text-2xl tracking-tight mb-4"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-zinc-900 border border-zinc-800 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/40 transition-all placeholder:text-zinc-700"
              />
            </div>
            ...
            <motion.button
              ...
              type="submit"
              disabled={isLoading}
              className="w-full h-12 bg-white text-black rounded-xl font-semibold flex items-center justify-center gap-2 text-sm hover:bg-primary hover:text-white transition-all disabled:opacity-50 mt-2"
            >
